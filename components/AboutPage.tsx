  ...
  return (
    <div className="pt-24 sm:pt-32 pb-16 sm:pb-20 container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center max-w-3xl mx-auto mb-16">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-text_light dark:text-text_dark">About ProbSolv</h1>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="space-y-12">
            <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-text_light dark:text-text_dark mb-4">Our Mission</h2>
            ...
            <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-text_light dark:text-text_dark mb-4">Our Philosophy</h2>
            <p className="text-base md:text-lg lg:text-xl text-subtext_light dark:text-subtext_dark leading-relaxed">
            ...
            <div ref={statsRef} className="grid md:grid-cols-3 gap-8 text-center pt-8">
              <div className="bg-bg_light dark:bg-surface_dark p-6 rounded-xl">
        ...
        <section className="mt-24">
            <h2 className="text-2xl sm:text-3xl font-bold text-text_light dark:text-text_dark text-center mb-12">Frequently Asked Questions</h2>
